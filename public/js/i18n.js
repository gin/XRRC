(function exposeI18n(root, factory) {
  ...
  const dictionaries = {
    en: {
      ...
      'dream.vehicleLabel': 'Invent a vehicle',
      'dream.mapLabel': 'Theme the map',
      'dream.generate': 'Generate',
      'dream.plateAria': 'Generated vehicle on a spinning display plate',
      'dream.sending': 'Sending to the model shop.',
      'dream.queued': 'Waiting in the paint queue.',
      'dream.progress': 'Sculpting. {progress}%',
      'dream.progressShort': '{progress}%',
      'dream.propReady': 'Ready',
      'dream.vehicleReady': 'Added to the vehicle bay and selected.',
      'dream.mapReady': 'Props ready. They will be on the track.',
      'dream.restored': 'Restored from your last visit.',
      'dream.taskFailed': 'Generation failed. Try a different prompt.',
      'dream.taskTimeout': 'Generation timed out. Try again.',
      'dream.error': 'Problem: {message}',
      'dream.role.landmark': 'Landmark',
      'dream.role.decor': 'Decor',
      'dream.role.marker': 'Marker',
    },
    es: {
      ...
      'vehicle.dream-car': 'Auto sonado',
      'dream.title': 'Laboratorio de suenos',
      'dream.hint': 'Creado con IA por Tripo mientras esperas a tus amigos.',
      'dream.vehicleLabel': 'Inventa un vehiculo',
      'dream.mapLabel': 'Ambienta el mapa',
      'dream.generate': 'Generar',
      'dream.plateAria': 'Vehiculo generado sobre una plataforma giratoria',
      'dream.sending': 'Enviando al taller de modelos.',
      'dream.queued': 'Esperando en la cola de pintura.',
      'dream.progress': 'Esculpiendo. {progress}%',
      'dream.progressShort': '{progress}%',
      'dream.propReady': 'Listo',
      'dream.vehicleReady': 'Anadido al garaje y seleccionado.',
      'dream.mapReady': 'Accesorios listos. Estaran en la pista.',
      'dream.restored': 'Restaurado de tu ultima visita.',
      'dream.taskFailed': 'La generacion fallo. Prueba otro texto.',
      'dream.taskTimeout': 'La generacion tardo demasiado. Intentalo de nuevo.',
      'dream.error': 'Problema: {message}',
      'dream.role.landmark': 'Monumento',
      'dream.role.decor': 'Decoracion',
      'dream.role.marker': 'Marcador',
    },
    fr: {
      ...
      'vehicle.dream-car': 'Auto de reve',
      'dream.title': 'Labo des reves',
      'dream.hint': 'Cree par IA avec Tripo pendant que tu attends tes amis.',
      'dream.vehicleLabel': 'Invente un vehicule',
      'dream.mapLabel': 'Theme du circuit',
      'dream.generate': 'Generer',
      'dream.plateAria': 'Vehicule genere sur un plateau tournant',
      'dream.sending': 'Envoi a l atelier de modeles.',
      'dream.queued': 'En attente dans la file de peinture.',
      'dream.progress': 'Sculpture. {progress}%',
      'dream.progressShort': '{progress}%',
      'dream.propReady': 'Pret',
      'dream.vehicleReady': 'Ajoute au garage et selectionne.',
      'dream.mapReady': 'Decors prets. Ils seront sur la piste.',
      'dream.restored': 'Restaure depuis ta derniere visite.',
      'dream.taskFailed': 'La generation a echoue. Essaie un autre texte.',
      'dream.taskTimeout': 'La generation a expire. Reessaie.',
      'dream.error': 'Probleme : {message}',
      'dream.role.landmark': 'Monument',
      'dream.role.decor': 'Decor',
      'dream.role.marker': 'Repere',
    },
  };
